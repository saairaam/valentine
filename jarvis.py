    ...
    def TaskExecution(self):
        ...
        while True:
            ...
            if "open notepad" in self.query:
                ...
                webbrowser.open("https://wynk.in/music/playlist/heart-break-tunes-tamil/bb_1589956556741")


         

            elif "you can sleep" in self.query or "sleep now" in self.query or "goodbye " in  self.query:
            ...
            #to find a joke
            elif "tell me a joke" in self.query or "tell me another joke "in self.query:
            ...
            #     os.system("rundll32.exe powrprof.dll,SetSuspendState 0,1,0")
                ...
                speak("I am Sairam's valentine")

            elif "what is love" or "tell me about love" in self.query:
                speak("It is 7th sense that destroy all other senses   ")
                speak("And I think it is just a mere illusion ")
                speak("It is waste of time")

            elif "who am i" in self.query:
                speak("If you can talk, then definitely you are a human")
            elif "how did you come to this world" in self.query:
                speak("Thanks to sairam i was created by him.")
            elif "what is your purpose" in  self.query:
            ...
            ###########################################################################################################################################
                ...
                if "send a file" in self.query:
                    email = 'saairaamprasad@gmail.com' # Your email
                    password = 'Konduru27' # Your email account password
                    ...
                    speak("to whom should i send this mail")
                    reciever=input('Email:')
                    to=reciever # Whom you are sending the message to
                    message = query # The message in the email

                    server = smtplib.SMTP('smtp.gmail.com', 587) # Connect to the server
                    server.starttls() # Use TLS
                    server.login(email, password) # Login to the email server
                    server.sendmail(email, to , message) # Send the email
...
class Main(QMainWindow):
    ...
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:/Users/saairaam prasad/Desktop/jarvis/iron.gif")
        self.ui.label.setMovie(self.ui.movie)
        self.ui.movie.start()
        self.ui.movie = QtGui.QMovie("C:/Users/saairaam prasad/Desktop/jarvis/iniial.gif")
